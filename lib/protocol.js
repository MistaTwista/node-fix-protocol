...
module.exports = (function () {
     ...
     * @returns {String}
     */
    FixProtocol.prototype.encode = function (obj, add_tsoh) {
        var message = this.E_STR;
        ...
        for (var key in obj) {
            ...
            if (Object.prototype.toString.call(obj[key]) === '[object Array]') {
                obj[key].forEach(function (item) {
                    chunks.push(this.DICT[key] + "=" + item);
                }.bind(this));
            }

            if (chunks.length) {
                message += chunks.join(this.SOH);
            } else {
            ...
            if (not.indexOf(this.DICT[key]) === -1) {
                if (chunks.length) {
                    this.TRIMED += chunks.join(this.SOH) + this.SOH;
                } else {
    ...
    FixProtocol.prototype._bodyLength = function () {
     ...
     * @returns {Number}
     */
    FixProtocol.prototype._checkSum = function (buff, buffLength) {
    ...
    FixProtocol.prototype._ord = function (str) {
     ...
     * @returns {undefined}
     */
    FixProtocol.prototype.resetSeq = function () {
        this.SEQNUM = 1;
    };
     ...
     * @returns {Number}
     */
    FixProtocol.prototype.seqNum = function () {
        this.SEQNUM++;
        return this.SEQNUM;
    };
