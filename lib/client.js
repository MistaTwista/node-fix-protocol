...
module.exports = (function () {
     ...
     * @returns {String}
     */
    FixClient.prototype.message = function (obj, add_tsoh) {
    ...
    FixClient.prototype._bodyLength = function () {
     ...
     * @returns {Number}
     */
    FixClient.prototype._checkSum = function (buff, buffLength) {
    ...
    FixClient.prototype._ord = function (str) {
     ...
     * @returns {Object}
     */
    FixClient.prototype.read = function (fixString) {
        if (!fixString) {
     ...
     * @returns {undefined}
     */
    FixClient.prototype.resetSeq = function () {
        this.SEQNUM = 1;
    };

    FixClient.prototype._flipp = function (trans) {
        var key, tmp_ar = {};
     ...
     * @returns {Number}
     */
    FixClient.prototype.seqNum = function () {
        this.SEQNUM++;
        return this.SEQNUM;
    };
